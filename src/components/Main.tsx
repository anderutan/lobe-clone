...
const Main = () => {
  ...
  return (
    <div className='w-full md:max-w-[1000px] md:w-4/5 md:mx-auto px-4 py-8 text-center'>
      ...
      <div className='rounded-xl bg-gray-200 relative'>
        {videoPlayToggled ? (
          <div className='fixed top-0 left-0 h-full w-full bg-white/5 backdrop-blur-[3px] flex justify-center items-center ease-in-out duration-500'>
            <motion.div
          ...
          <div
            className='absolute my-16 ease-in-out duration-500'
            onClick={() => setVideoPlayToggled(!videoPlayToggled)}
          >
            <img
              src={videoImg}
              alt=''
              className='w-full bg-green-200  rounded-xl hover:shadow-2xl hover:scale-105 ease-in-out duration-500 cursor-pointer'
            />
          </div>
        )}
      </div>
